...
def _read_decoded_value_from_secret(secret_name, secret_key, namespace):
...
def _add_external_tls_init_container(ctx, init_containers, volumes, external_cert, external_tls_config, namespace):
    ...
    env["KEYSTORE_PASSWORD"] = _read_decoded_value_from_secret(external_tls_config.get("password_secret_name"), external_tls_config.get("keystore_password_secret_key"), namespace)
    env["TRUSTSTORE_PATH"] = MOUNT_PATH + truststore_secret_key
    env["TRUSTSTORE_PASSWORD"] = _read_decoded_value_from_secret(external_tls_config.get("password_secret_name"), external_tls_config.get("truststore_password_secret_key"), namespace)
