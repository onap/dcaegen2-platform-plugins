...
def _set_defaults():
    ...
    return {
        ...
        "external_cert": {
            ...
            "keystore_password_secret_name": EXT_TLS_KEYSTORE_PASSWORD_SECRET_NAME, # Name of secret containing passwrods for keystore for secure communication of Cert Service Client and Cert Service
            "truststore_password_secret_name": EXT_TLS_TRUSTSTORE_PASSWORD_SECRET_NAME, # Name of secret containing passwrods for truststore for secure communication of Cert Service Client and Cert Service
